<?php include("../HeadFoot/header.php");
    ...
    if(isset($loc) && $loc == 'ML' ){
        $sql = "SELECT * from locations ORDER BY likes DESC";    
    }else if(isset($cit)){
        $sql = "SELECT * from locations WHERE city='$cit' ORDER BY date DESC";
    }else{
        $sql = "SELECT * from locations WHERE region='$loc' ORDER BY date DESC";
    }
